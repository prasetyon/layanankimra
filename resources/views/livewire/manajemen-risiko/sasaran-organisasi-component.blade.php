    ...
    <form method="POST" wire:submit.prevent="store()">
        <div class="card-body">
            ...
            <div class="form-group col-12">
                <label for="input_kode">Kode SO</label>
                <input type="text" wire:model="input_kode" id="input_kode" class="form-control @error('input_kode') is-invalid @enderror">
                @error('input_kode') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="form-group col-12">
                <label for="input_name">Nama SO</label>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td class="text-left">{{ $list->kode.' '.$list->name }}</td>
