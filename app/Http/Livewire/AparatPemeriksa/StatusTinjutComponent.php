...
class StatusTinjutComponent extends Component
{
    // Load addon trait
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.aparatpemeriksa.status-tinjut-component', [
            // Lists
            'lists' => StatusAksi::when($searchData, function ($searchQuery) use ($searchData) {
                $searchQuery->where([
    ...
    public function store()
    {
        ...
        StatusAksi::updateOrCreate(['id' => $this->input_id], [
    ...
    {
        // Find existing photo
        $sql = StatusAksi::where('id', $id)->firstOrFail();
